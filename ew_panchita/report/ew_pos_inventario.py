...
class ew_pos_inventario(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context=None):
        super(ew_pos_inventario, self).__init__(cr, uid, name, context=context)
        self.resultado_consulta = []
        self.localcontext.update({

            'getInventoryData': self.getInventoryData,
...
class pos_inventario(osv.AbstractModel):
    _name = 'report.ew_panchita.pos_inventario'
    _inherit = 'report.abstract_report'
    _template = 'ew_panchita.pos_inventario'# llama al pdf que tienen que imprimir
    _wrapped_report_class = ew_pos_inventario
