...
class ew_reporte_nota_venta(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(ew_reporte_nota_venta, self).__init__(cr, uid, name, context=context)
...
#            'get_username': self.get_username,
            ...
            '_subtotaSinImpuestos': self._subtotaSinImpuestos,
    ...
    def _subtotaSinImpuestos(self, subtotal):
        subtotalimpuestos = subtotal * 0.13
...
class ew_nota_venta(osv.AbstractModel):
    _name = 'report.ew_quilocons.ew_nota_venta'
    _inherit = 'report.abstract_report'
    _template = 'ew_quilocons.ew_nota_venta'
    _wrapped_report_class = ew_reporte_nota_venta
